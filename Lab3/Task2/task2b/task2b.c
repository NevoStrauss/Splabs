...
// printf("Discrepancy in byte: %d\n", susIndex + i);
// printf("Virus name: %s\n", virnamearr);
// printf("Virus signature's size: %d", sigSize);
//
//  // for test only - changing a specific spot in one of the viruses sig
// buffer[27] = '\0';
// buffer[29] = '\0';
// buffer[132] ='\0';
// - start from index 4
...
// short sigSize;
// link *currLink = virus_list;
// virus *currVir = virus_list->vir;
// //virus currVir
// while (susIndex < size)
// {
// //copying size
// // memcpy(sigsizearr, buffer + susIndex, 2);
// copying name
// memcpy(virnamearr, buffer + susIndex + 2, 16);
// susIndex += 18;
// sigSize = calcLitlleEndian(sigsizearr[0], sigsizearr[1]);
// short foundIllegalIndex =-1;
// const char *currSig = currVir->sig;
// printf("\nTaking care in **%s** virus, in size: %d\n", virnamearr, sigSize);
// for (int i = 0; i < sigSize; i++)
// {
// if ((buffer[susIndex + i] != currSig[i]&& foundIllegalIndex==(-1)))
// {
// foundIllegalIndex=i;
// printf("found illegal in %d\n", i);
// printf("Discrepancy starts in byte: %d\n", susIndex + i);
// printf("Virus name: %s\n", virnamearr);
// printf("Virus signature's size: %d", sigSize);
// }
//
